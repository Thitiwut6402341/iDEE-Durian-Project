...
exports.EditOrchardInfoDto = void 0;
var class_validator_1 = require("class-validator");
var EditOrchardInfoDto = function () {
    var _a;
    var _orchard_code_decorators;
    var _orchard_code_initializers = [];
    var _orchard_code_extraInitializers = [];
    return _a = /** @class */ (function () {
            function EditOrchardInfoDto() {
                this.orchard_code = __runInitializers(this, _orchard_code_initializers, void 0);
                this.orchard_name = __runInitializers(this, _orchard_code_extraInitializers);
            }
            return EditOrchardInfoDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _orchard_code_decorators = [(0, class_validator_1.IsNotEmpty)()];
...
exports.EditOrchardInfoDto = EditOrchardInfoDto;
